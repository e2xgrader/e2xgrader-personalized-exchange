...
import nbgrader.exchange.default.release_assignment as default_release_assignment

from .exchange import Exchange


class ExchangeReleaseAssignment(Exchange, default_release_assignment.ExchangeReleaseAssignment):
    def init_dest(self):
